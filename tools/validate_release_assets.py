...
# Additional 40-hex revisions a document may legitimately cite.
...
CODE_MARKERS = (
    'from qwen3_reranker_pipeline import DEFAULT_INSTRUCTION, MAX_PAIRS, MAX_TEXT_CHARS, MAX_TEXT_TOK'
    'ENS',
    'from qwen3_reranker_pipeline import MODEL_ID, MODEL_KEY, MODEL_REVISION, Qwen3RerankerPipeline, '
    'stage_missing_files, verify_snapshot',
    ...
    "ceilings = {'MAX_PAIRS': MAX_PAIRS, 'MAX_TEXT_CHARS': MAX_TEXT_CHARS, 'MAX_TEXT_TOKENS': MAX_TEX"
    'T_TOKENS}',
    'instruction = DEFAULT_INSTRUCTION',
    "raise ValueError('input rejected before model execution: '",
